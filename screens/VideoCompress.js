...
export default class VideoCompress extends Component {
    trimVideo() {
        const options = {
            startTime: 0,
            endTime: 15,
        ...
        return (
            <View style={{ flex: 1 }}>
                <VideoPlayer
                    ...
                    source={'content://com.mi.android.globalFileexplorer.myprovider/external_files/WhatsApp/Media/WhatsApp%20Video/VID-20200101-WA0001.mp4'}
